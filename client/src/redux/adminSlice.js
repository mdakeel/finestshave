...
export const getAdminData = () => {
    return async (dispatch, getState) => {
        ...
        try {
            const resp = await fetch("http://127.0.0.1:8081/admin/admindata", {
                method: "GET",
...
export const roleSwitch = (id, toast) => {
    return async (dispatch, getState) => {
        const userId = localStorage.getItem("TOKEN");
        try {
            const resp = await fetch(`http://127.0.0.1:8081/admin/user/${id}`, {
                method: "PATCH",
                headers: { "Content-type": "application/json", "authorization": `bearer ${userId}` },
            });
            toast({
...
export const deleteCartItem = (id, toast) => {
    return async (dispatch, getState) => {
        const userId = localStorage.getItem("TOKEN")
        try {
            const resp = await fetch(`http://127.0.0.1:8081/admin/cart/${id}`, {
                method: "DELETE",
                headers: { "Content-type": "application/json", "authorization": `bearer ${userId}` },
            });
            toast({
...
export const deleteProduct = (id, toast) => {
    return async (dispatch, getState) => {
        const userId = localStorage.getItem("TOKEN")
        try {
            const resp = await fetch(`http://127.0.0.1:8081/admin/product/${id}`, {
                method: "DELETE",
                headers: { "Content-type": "application/json", "authorization": `bearer ${userId}` },
            });
            toast({
...
export const deleteOrder = (id, toast) => {
    return async (dispatch, getState) => {
        const userId = localStorage.getItem("TOKEN")
        try {
            const resp = await fetch(`http://127.0.0.1:8081/admin/order/${id}`, {
                method: "DELETE",
                headers: { "Content-type": "application/json", "authorization": `bearer ${userId}` },
            });
            toast({
...
export function AddProduct(data, toast) {
    return async function (dispatch, getState) {
        const userId = localStorage.getItem("TOKEN")
        try {
            const sendData = await fetch("http://127.0.0.1:8081/admin/product", {
                method: "POST",
                headers: {
